...
export default function Contact(): JSX.Element {
    return (
        <div className={classNames('contact')}>
          ...
          <p className={'mt-10'}>  <em>Ungenotes</em> ist ein freies, quelloffenes Programm, welches auf <a style={{color: 'blue', textDecoration: 'underline'}} href={VersionHelper.repoUrl}>GitHub</a> veröffentlich ist.
